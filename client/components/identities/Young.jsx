        ...
        return (
            <div className="">
                ...
                <div className="has-text-centered">
                    <h3 className="subtitle is-size-3">In the last five years, <br/> the number of youth (age 15-24) <br/> who report struggling with mental health distress has</h3>
              ...
              <div className="has-text-centered">
                    ...
                    <h1 className="title is-size-1">
                        <span className="has-text-info">highest suicide rate in the developed world.</span> 
                    </h1>
                </div>
